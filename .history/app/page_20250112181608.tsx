            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  action: () => document.querySelector('.fixed.bottom-4.right-4')?.classList.remove('hidden'),
                ...
                >
                  <Card className="relative overflow-hidden border-none bg-white/70 dark:bg-gray-800/50 backdrop-blur-lg">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button 
                        ...
                        className="group text-blue-600 dark:text-blue-400 p-0 hover:no-underline"
                      >
                        {feature.link ? (

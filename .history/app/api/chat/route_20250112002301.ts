  ...
  try {
    ...
    const chat = model.startChat({
      history: [
        ...
        {
          role: 'model',
          parts: [{ text: 'Understood. I am now an AI assistant for GovEase, specializing in Indian government schemes. I amm ready to help users with information about various schemes, eligibility criteria, and application processes. How may I assist you today?' }],
        },
      ],
      generationConfig: {
        temperature: 0.9,
